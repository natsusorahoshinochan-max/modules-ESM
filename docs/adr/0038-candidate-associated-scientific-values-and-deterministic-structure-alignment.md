...
and a subjectless `structure_prediction.confidence_facts@1.0.0` value. For each
...
`structure_prediction.prediction_residue_axis@1.0.0` content digest. The fact
...
`structure_prediction.materialize_confidence@1.0.0`, through
`structure_prediction.materialize_confidence.direct@1.0.0` and
`structure_prediction.materialize_confidence.exact_reference_join@1.0.0`, is
...
the Score subject and populate `score.collection@4.0.0`.
