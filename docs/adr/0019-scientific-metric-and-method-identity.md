...
identity is the Candidate being evaluated, the Metric being observed, the stable
...
startup. Persisted Workflows and selectors target stable Metric and Method IDs and an
...
identity. Any result-affecting stable Binding, Adapter, or implementation
identity still enters Result Identity under ADR-0031. Provider installation
form and CPU/GPU device do not. Identical observations
